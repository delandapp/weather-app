...
const dataKota = document.getElementById("data-kota");
...
fetch(
  ...
  .then((response) => {
    ...
    data.then((data) => {
      ...
      suhu.previousElementSibling.previousElementSibling.innerHTML =
        data.resolvedAddress;
      suhu.innerHTML = data.currentConditions.temp + "°C";
      cuaca.innerHTML = data.currentConditions.conditions;
      dataKota.children[0].children[1].innerHTML =
        data.currentConditions.temp + "°C";
      dataKota.children[1].children[1].innerHTML =
        data.currentConditions.humidity + "%";
      dataKota.children[2].children[1].innerHTML =
